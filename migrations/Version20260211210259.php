...
final class Version20260211210259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, `row_number` INT NOT NULL, seat_number INT NOT NULL, customer_email VARCHAR(255) NOT NULL, owner_id INT NOT NULL, screening_id INT NOT NULL, INDEX IDX_42C849557E3C61F9 (owner_id), INDEX IDX_42C8495570F5295D (screening_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
